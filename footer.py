...
def render_footer():
    """Render the Injaz footer component using HTML component."""
    ...
    <body>
        <div class="injaz-footer">
            ...
            <!-- 2. تطوير وتنفيذ -->
            <div class="row">
                <span class="label">تطوير وتنفيذ:</span> 
                <span class="name">Sahar Osman</span>
            </div>
            <div class="row" style="font-size: 0.95rem; color: #E5C75A; font-weight: 600; margin-top: 2px;">
            ...
            <div class="row">
                <a href="https://www.linkedin.com/in/sahar-osman-a19a45209/" target="_blank" class="linkedin-link">
    ...
    # Use components.html instead of st.markdown for better rendering
